...
const MyPortfolio = () => {
  return (
    <div className="grid grid-cols-2 justify-items-center gap-0 bg-zinc-800 text-white py-10">
      <div className="mx-12">
        {/* Left Side */}
        ...
        <div className=" shadow-lg border-gray-600 rounded-lg bg-gray-700 text-white flex flex-col hover:scale-110 transition-all duration-200 gap-4 w-[350px]  mx-32 my-8 pb-0">
      ...
      <div className="">
        ...
        <div className="m-auto ">
          <div className=" shadow-lg border-gray-600 rounded-lg bg-gray-700 text-white hover:scale-110 transition-all duration-200 flex flex-col gap-4 w-[350px]  mx-32 my-8 pb-0 ">
