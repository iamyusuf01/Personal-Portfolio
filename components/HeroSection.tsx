...
const HeroSection = () => {
  return (
    <section>
        ...
        <div className="grid grid-cols-2 gap-12 justify-between absolute">
          {/* Right Side */}
          <div className="realtive mt-12">
            <div className="w-18 h-1 bg-white mb-4"></div>
            <h1 className="text-4xl font-bold leading-tight">I'm John, a <br/> Web Developer</h1>
          ...
          <div className="ml-22">
            ...
            <div className="group">
              ...
              <div className="h-1 rounded-2xl bg-gray-400 transition-colors duration-300 group-hover:bg-white  w-36"></div>
            </div>
            <hr className="mt-8"/>
            {/* My Work  */}
            <div className="mt-8">
